...
Mac worker → Supabase 폴링 (1초마다)
           ...
           → Cloudflare R2 업로드 → 로컬 source 삭제
...
| `R2_ACCESS_KEY_ID` | R2 Object Read & Write access key |
| `R2_SECRET_ACCESS_KEY` | R2 Object Read & Write secret |
| `R2_BUCKET` | source 원본을 저장할 R2 bucket |
